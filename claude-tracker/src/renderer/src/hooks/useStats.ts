...
export interface RateLimits { sessionPercent: number; sessionResetIn: string; weeklyPercent: number; weeklyResetAt: string; sessionTokens: number; weeklyTokens: number; sessionLimit: number; weeklyLimit: number }
